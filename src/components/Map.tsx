...
export const MapMain = ({
  ...
  const screen = useSelector(getCurrentScreen);
  ...
  // move to some kind of "useMap" hook so it would return active routes
  // and boundaries
  const routes =
    screen.type === PossibleScreens.searchResultScreen
      ? screen.results
      : screen.type === PossibleScreens.routeScreen
      ? [screen.route]
      : [];
